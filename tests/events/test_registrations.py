...
LEICA_EVENTS = [
    ...
    'leadorder.created',
    'leadorder.updated',
    'leadorder.workflow.confirm',
    'leadorder.workflow.remove_confirmation',
    'leadorder.workflow.accept',
    'leadorder.workflow.assign',
    'leadorder.workflow.cancel',
    'leadorder.workflow.deliver',
    'leadorder.workflow.edit_location',
    'leadorder.workflow.edit_requirements',
    'leadorder.workflow.new_shoot',
    'leadorder.workflow.perm_refuse',
    'leadorder.workflow.reassign',
    'leadorder.workflow.refuse',
    'leadorder.workflow.remove_availability',
    'leadorder.workflow.remove_schedule',
    'leadorder.workflow.require_revision',
    'leadorder.workflow.reshoot',
    'leadorder.workflow.schedule',
    'leadorder.workflow.set_availability',
    'leadorder.workflow.start_qa',
