...
LEICA_EVENTS = [
    ...
    ('assignment.workflow.perm_reject', 1),
    ...
    ('leadorder.created', 1),
    ('leadorder.updated', 1),
    ('leadorder.workflow.confirm', 1),
    ('leadorder.workflow.remove_confirmation', 1),
    ('leadorder.workflow.accept', 1),
    ('leadorder.workflow.assign', 1),
    ('leadorder.workflow.cancel', 1),
    ('leadorder.workflow.deliver', 1),
    ('leadorder.workflow.edit_location', 1),
    ('leadorder.workflow.edit_requirements', 1),
    ('leadorder.workflow.new_shoot', 1),
    ('leadorder.workflow.perm_refuse', 1),
    ('leadorder.workflow.reassign', 1),
    ('leadorder.workflow.refuse', 1),
    ('leadorder.workflow.remove_availability', 1),
    ('leadorder.workflow.remove_schedule', 1),
    ('leadorder.workflow.require_revision', 1),
    ('leadorder.workflow.reshoot', 1),
    ('leadorder.workflow.schedule', 1),
    ('leadorder.workflow.set_availability', 1),
    ('leadorder.workflow.start_qa', 1),
    ('leadorder.workflow.submit', 1),
    ...
    ('order.workflow.edit_location', 1),
    ('order.workflow.edit_requirements', 1),
